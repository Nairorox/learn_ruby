...
describe "#multiply" do
  ...
  it "multiplies several negative numbers" do
  expect(multiply([-2, -1 , -3, 7])).to eq (-42)
  end
...
describe "#power" do
  ...
  expect(power(137, 2)).to eq (18769)
  end

  it "raises one number to the power of 0" do
  expect(power(26, 0)).to eq (1)
  end

  it "raises one number to the power of negative number" do
